...
parser.add_argument('--input_annotation_txt_dir',default='./data/dataset/labels/train/',required=False,type=str,help='输入存储图片的标注txt文件(注意不要有中文)')
parser.add_argument('--output_anchors_txt',default='create_anchors.txt',required=False,type=str,help='输出的存储Anchor boxes的文本文件')
parser.add_argument('--input_num_anchors',default= 12,required=False,type=int,help='输入要计算的聚类（Anchor boxes的个数）')
parser.add_argument('--input_cfg_width',default= 640,required=False,type=int,help="配置文件中width")
parser.add_argument('--input_cfg_height',default= 640,required=False,type=int,help="配置文件中height")
